 ...
 **************************************************************************/
    ...
    #define TASK_2_STACK_SIZE 300/4 // size = 300 bytes
    int EE_cortex_mx_stack_2[TASK_2_STACK_SIZE];	/* Task 2 (tsk_Control) */
    #endif
    ...
    int EE_cortex_mx_stack_4[TASK_4_STACK_SIZE];	/* Task 4 (tsk_LEDs_Fading) */
    #endif
    #if ((1 == 2) && (EE_MAX_TASK > 4))
    #define TASK_5_STACK_SIZE 0/4 // size = 0 bytes
    int EE_cortex_mx_stack_5[TASK_5_STACK_SIZE];	/* Task 5 (tsk_RGB_Glowing) */
    #endif
    ...
    #endif
    #if EE_MAX_TASK > 3
        ,Tsk4	 /* tsk_LEDs_Fading*/
    #endif
    #if EE_MAX_TASK > 4
        ,Tsk5	 /* tsk_RGB_Glowing*/
    #endif
    #if EE_MAX_TASK > 5
        ,Tsk6	 /* Task_6*/
    #endif
    ...
    struct EE_TOS EE_cortex_mx_system_tos[EE_CORTEX_MX_SYSTEM_TOS_SIZE] = {
        ...
        #endif
        #ifdef TASK_2_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_2[(TASK_2_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}	/* tsk_Control*/
        #endif
        #ifdef TASK_3_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_3[(TASK_3_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])} 	/* tsk_Background*/
        #endif
        #ifdef TASK_4_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_4[(TASK_4_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_LEDs_Fading*/
        #endif
        #ifdef TASK_5_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_5[(TASK_5_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_RGB_Glowing*/
        #endif
        #ifdef TASK_6_STACK_SIZE
 ...
 **************************************************************************/
    ...
    #endif
    #if EE_MAX_TASK > 3
    DeclareTask(tsk_LEDs_Fading);
    #endif
    #if EE_MAX_TASK > 4
    DeclareTask(tsk_RGB_Glowing);
    #endif
    #if EE_MAX_TASK > 5
    DeclareTask(Task_6);
    #endif
    ...
    #endif
    #if EE_MAX_TASK > 3
        ,&EE_oo_thread_stub      /* thread tsk_LEDs_Fading */
    #endif
    #if EE_MAX_TASK > 4
        ,&EE_oo_thread_stub      /* thread tsk_RGB_Glowing */
    #endif
    #if EE_MAX_TASK > 5
...
#endif
#if (EE_MAX_ALARM > 1) && (3 == 3)
    void Counter_Ticks(void);
#endif
 ...
 **************************************************************************/
    ...
    const EE_oo_counter_object_ROM_type   EE_oo_counter_object_ROM[EE_COUNTER_OBJECTS_ROM_SIZE] = {
        #if EE_MAX_ALARM > 0
        {0, Rand_Time, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 1
        ,{0, alrm_1ms, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 2
        ,{0, alrm_10ms, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 3
        ,{0, alrm_Glowingtime, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 4
        ,{0, Alarm_5, EE_ALARM }
        #endif
